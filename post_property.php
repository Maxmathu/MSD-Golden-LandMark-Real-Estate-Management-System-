...
<body style="background: url('images/property04.jpeg') no-repeat;
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="  write about property..." style="border-radius:50px;"></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
